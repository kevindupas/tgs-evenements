                ...
                <form method="POST" action="{{ route('login') }}" class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                    ...
                    <div class="my-auto mx-auto xl:ml-20 bg-white dark:bg-dark-1 xl:bg-transparent px-5 sm:px-8 py-8 xl:p-0 rounded-md shadow-md xl:shadow-none w-full sm:w-3/4 lg:w-2/4 xl:w-auto">
                        ...
                        <div class="intro-x mt-8">
                            <input type="email" name="email" :value="old('email')" required autofocus class="intro-x login__input form-control py-3 px-4 border-gray-300 block" placeholder="{{ __('Email') }}">
                            <input type="password" name="password" required autocomplete="current-password" class="intro-x login__input form-control py-3 px-4 border-gray-300 block mt-4" placeholder="{{ __('Password') }}">
                        </div>
