...
use App\Http\Livewire\Salons\Salons;
use App\Http\Livewire\Salons\Salonposts;
...
Route::get('dashboard/salons', Salons::class)->name('salons');
Route::get('dashboard/salons/{id}/posts', Salonposts::class);
