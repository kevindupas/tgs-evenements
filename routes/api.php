...
//Route::get('categories/{id}/posts/{salon_id}/{tag_id?}', [CategoryApiController::class, 'posts']);

Route::get('posts/categories/{id}/salon/{salon_id}', [CategoryApiController::class, 'posts']);
Route::get('posts/categories/{id}/salon/{salon_id}/tag/{tag_id}', [CategoryApiController::class, 'posts']);
...
Route::get('salons/{id}/posts', [SalonApiController::class, 'posts']);
